...
const Profile = () => {
  return (
    <div className={s.content}>
      <div>
        <img src='https://avatars.mds.yandex.net/get-kinopoisk-image/6201401/731c4031-7389-44f4-8c15-f9f4e3b0ed90/300x450' />
      <button>О фильме
Год производства
2021
Страна
...
Майкл Джаккино
Художник
Arnela Connell, Даррен Гилфорд, Лорен Абиунесс, ...</button>
      </div>
      <div>
